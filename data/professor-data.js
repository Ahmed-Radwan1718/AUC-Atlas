(function () {
  const professors = [
    ...
    ...[
      ...
      "Reham Abou-Zeid", "Hanan Abozaied", "Mohamed Abu El Kheir", "Amr Abu Helw", "Nayera Abusetit", "Karim Addas", "Amr Adly", "Reem Ahmed",
      "Samah Ahmed", "Yasmine Ahmed", "Salah Alagha", "Firas Al Atraqshi", "Eman Al-Ayyat", "Mohamed Alhalaby", "Ramy Ali", "Aya Alkholy",
      "Salma Al-Saady", "Ibrahim Al-Sahouly", "Mohamed Aly", "Ramy Aly", "Sherif Aly", "Hassanein Amer", "Mona Amer", "Ayatalla Amin",
      ...
      "Maha Bali", "Karim Banawan", "Christopher Barker", "Ghada Barsoum", "Reem Bassiouney", "Dina Bassiouni", "Mohamed Basuony", "Nizar Becheikh",
      "Teklu Bekele", "Catarina Belo", "Shahjahan Bhuiyan", "Mohammed Bouaddi", "Kamal Boutros", "Jochen Braun", "Heather Browne", "Rodrigo Brum",
      ...
      "Hadeel El-Ahraf", "Maha El-Ashram", "Ashraf El Assaly", "Amira El Ayouty", "Ahmed ElBanbi", "Dina El-baradie", "Dina El Basiouny", "Tamer ElBatt",
      ...
      "Rasha El Kholy", "Tamir El-Khouly", "Hoda El Kolaly", "Tamer El-Leithy", "Addison Ellis", "Rehab El-Maghraby", "Wael El-Mahallawy",
      ...
      "Omneya Helmy", "Hani Henry", "Michelle Henry", "Dina Heshmat", "Rana Hindy", "John Hoey", "Dina Hosni", "Ossama Hosny",
      ...
      "Salwa Mostafa", "Youssef Mostafa", "Yasmine Motawy", "Lobna Mourad", "Maha Mourad", "Hanan Moussa", "Ahmed Moustafa", "Rida Moustafa",
      "Mark Muehlhaeusler", "Isabel Muller", "Aya Musmar", "Maha Muttardi", "Peter Nasr", "Khalid Nassar", "Ashraf Nassef", "Haytham Nawar",
      ...
      "Rania Samir", "Ahmad Saqfalhait", "Ezzeldin Sayed-Ahmed", "Ariane Schneck", "Olivier Schouteden", "Manuel Schwab", "Karim Seddik", "Sherif Sedky",
      ...
      "Amro Shetta", "Hania Sholkamy", "Marwah Siam", "Daoud Siniora", "Sarah Smierciak", "Ezzeldin Soliman", "Marwa Soliman", "Mohamed Swillam",
      ...
      "Moustafa Youssef", "Noha Youssef", "Youssri Youssri Ahmed", "Malak Zaalouk", "Suher Zada", "Angie Zaher", "Aida Zakaria", "Nour Zaki",
