(function () {
  const professors = [
    ...
    { id: "nour-zaki", name: "Nour Zaki", department: "Psychology", displayDepartment: "PSYC", filterDepartment: "Humanities", status: "No ratings yet", course: "Courses coming soon", group: "N-Z", email: "", bio: "Nour Zaki is an assistant professor of developmental psychology and director of AUC’s Attachment Lab. Her work focuses on childhood attachment, adult development, and intergenerational relationships.", image: "https://res.cloudinary.com/hpsuzs6q/image/upload/v1786028121/Nour_Zaki_cfwgwe.jpg" },
    { id: "hassan-zaky", name: "Hassan Zaky", department: "Psychology", displayDepartment: "PSYC", filterDepartment: "Humanities", status: "No ratings yet", course: "Courses coming soon", group: "G-M", email: "", bio: "Hassan Zaky earned his PhD from Johns Hopkins University before joining AUC. His work focuses on demography, population health, fertility, surveys, and health policy.", image: "https://res.cloudinary.com/hpsuzs6q/image/upload/v1786028037/Hassan_Zaky_pwu6fb.png" },
